<header class="d-flex ps-5 pe-5 pt-4 pb-4 header">
    <nav class="navbar navbar-expand-lg navbar-dark bg-black w-100">
        <div class="container-fluid ">
            <a class="h2 mb-0" href="{{ URL::route('home') }}"><span class="green">RUSTIX</span><span
                    class="white">.COM</span>
            </a>
            ...
            @if (Auth::check())
                <balance class="text-center nav-item mx-3 py-3 fw-bold " style="color: rgb(255, 255, 255)"
